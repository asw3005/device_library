...
#define DirectionDataWrite		DirectionData = 0 // Запись данных в регистры ведомого устройства
#define DirectionDataRead		DirectionData = 1 // чтение данных из регистров ведомого устройства
...
void DS1307_Init(void);														//Настройка RTC
