...
static IDRevisionSendCommandStruct IDRevisionSendCommand = { 
		ReadElectronicIDFirstBytePart1, 
	    ReadElectronicIDFirstBytePart2, 
		ReadElectronicIDSecondBytePart1, 
		ReadElectronicIDSecondBytePart2, 
		ReadFirmwareRevisionPart1, 
		ReadFirmwareRevisionPart2
	};
...
{	
	...
	SI7021ConfigStruct.ControlRegister.bitsControlRegister.RES0 = 0;
	SI7021ConfigStruct.ControlRegister.bitsControlRegister.RES1 = 0;
	SI7021ConfigStruct.ControlRegister.bitsControlRegister.HTRE = 0;
...
{	
	...
	SI7021ConfigStruct.HeaterControlRegister.bitsHeaterControlRegister.Heater = 0;
