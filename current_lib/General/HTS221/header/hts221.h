...
typedef enum 
{
	...
	CTRL_REG_3		= 0x22,
	///type R, default 0x00
	STATUS_REG		= 0x27 | AUTOINC_ENABLE,
	///type R, output data
	HUMIDITY_OUT_L	= 0x28,
	///type R, output data
	HUMIDITY_OUT_H	= 0x29,
	...
	///type R, output data
	TEMP_OUT_H		= 0x2B,
	///type R/W, calibration data, DON'T MODIFY, range 0x30 - 0x3F
	CALIB_START		= 0x30 | AUTOINC_ENABLE,
	CALIB_STOP		= 0x3F,
	
	
}  HTS221_AddressReg_typedef_enum;
...
void HTS221_Set_Av_Conf(HTS221_typedef *dev_hts221, HTS221_Av_Conf_enum av_conf_t, HTS221_Av_Conf_enum av_conf_h);
void HTS221_Set_Ctrl_Reg_1(HTS221_typedef *dev_hts221, HTS221_Ctrl_Reg1_enum odr, HTS221_Ctrl_Reg1_enum bdu, HTS221_Ctrl_Reg1_enum pd);
void HTS221_Set_Ctrl_Reg_2(HTS221_typedef *dev_hts221, HTS221_Ctrl_Reg2_enum one_shot, HTS221_Ctrl_Reg2_enum heater, HTS221_Ctrl_Reg2_enum boot); 
void HTS221_Set_Ctrl_Reg_3(HTS221_typedef *dev_hts221, HTS221_Ctrl_Reg3_enum drdy_en, HTS221_Ctrl_Reg3_enum pp_od, HTS221_Ctrl_Reg3_enum drdy_h_l);
